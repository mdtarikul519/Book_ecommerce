    ...
    <div style="margin-top: 100px;">
        <div class="card rounded-none">
            <div class="card-header pt-3 pb-1 d-flex justify-content-between align-items-center">
                <div><h4 class="bn" style="font-size: 22px !important;">All Blog</h4></div>
                <div class="d-flex justify-content-between">
                    ...
                    <div class="ps-3 d-flex gap-2"><a href="{{ route('dashboard.banner.create')}}" class="btn btn-sm btn-info"> Create </a></div>
                </div>
            </div>
