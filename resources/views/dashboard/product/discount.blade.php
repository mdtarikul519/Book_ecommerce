                        ...
                        <div class="form-group d-grid col-lg-4 align-content-start gap-1 mb-2">
                            <div class="field_wrapper">
                                <label for="stock" class="text-capitalize d-block">
                                    ...
                                    <input type="number" value="{{$product_price->main_price}}" name="main_price" class="form-control" />
                                    <!---->
                                </label>
                                <!---->
                            </div>
                        ...
                        <div class="form-group d-grid col-lg-4 align-content-start gap-1 mb-2">
                            <div class="field_wrapper">
                                <label for="stock" class="text-capitalize d-block">
                                    ...
                                    <input type="number" value="{{$product_price->discount_percent}}" name="discount_percent" class="form-control" />
                                    <!---->
                                </label>
                                <!---->
                            </div>                    
                        ...
                        <div class="form-group d-grid col-lg-4 align-content-start gap-1 mb-2">
                            <div class="field_wrapper">
                                <label for="stock" class="text-capitalize d-block">
                                    ...
                                    <input type="number" value="{{$product_price->discount_price}}" name="discount_price" class="form-control" />
                                    <!---->
                                </label>
                                <!---->
                            </div> 
